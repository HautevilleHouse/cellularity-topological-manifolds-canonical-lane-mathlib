...
def mathlibProofObligation : MathlibProofObligation := {
  sourceKey := "cellularity-topological-manifolds-canonical-lane",
  theoremObject := "Cellularity of topological manifolds",
...
def theoremSpecificEndgamePilotClosed : Prop :=
  forall A : AdmissibleClass, ConstrainedCellularityClosure A

theorem theorem_specific_endgame_pilot_checked :
    theoremSpecificEndgamePilotClosed := by
  intro A
  exact constrained_cellularity_endgame A
